...
class Pipeline:
    ...
    def run(self):
        ...
        print("pred path num poses: ", len(self.odometry_manager.get_pred_path()))
        print("gt path num poses: ", len(self.odometry_manager.get_gt_path()))
        # input()
...
if __name__ == "__main__":
    config_dir = r"C:\Users\SamuelChee\Desktop\FYP\opencv_optical_flow\pipeline\config\pipeline_config_4km.ini"
